      ...
      <div className="markdown-content">
        <ReactMarkdown
          ...
          components={{
            ...
            pre: ({ children }) => (
              <pre className="bg-dark-bg p-4 rounded-lg overflow-x-auto my-4 border border-dark-border">
                {children}
              </pre>
            ),
            table: ({ children }) => (
            ...
            thead: ({ children }) => (
              <thead className="bg-dark-card">{children}</thead>
            ),
            tbody: ({ children }) => (
              <tbody className="divide-y divide-dark-border">{children}</tbody>
            ),
            tr: ({ children }) => (
              <tr className="hover:bg-dark-card/50 transition-colors">{children}</tr>
            ),
            th: ({ children }) => (
